...
#datasets
plastic_waste <- read.csv("data/piece_6/plastic-waste.csv")
nobel <- read_csv("data/piece_6/nobel.csv")
states <- read_csv("data/piece_6/states.csv")
staff <- read_csv("data/piece_6/instructional-staff.csv")
```
